...
const COLOR_PROPERTY_NAMES: Record<ColorProperty, string> = {
  ...
  redAlliance: 'Red Alliance Color',
  blueAlliance: 'Blue Alliance Color',
  successColor: 'Success Color',
  errorColor: 'Error Color',
  warningColor: 'Warning Color',
  infoColor: 'Info Color',
  skillsColor: 'Skills Ranking Color',
  phase1Color: 'Calculator Phase 1',
  phase2Color: 'Calculator Phase 2',
  phase3Color: 'Calculator Phase 3',
  bonusColor: 'Bonus Points Color',
  switchTrackColorOff: 'Switch Track (Off)',
  switchThumbColorOn: 'Switch Thumb (On)',
  switchThumbColorOff: 'Switch Thumb (Off)',
  worldEventColor: 'World Event (Gold)',
  nationalEventColor: 'National Event (Red)',
  regionalEventColor: 'Regional Event (Purple)',
  stateEventColor: 'State Event (Teal)',
  signatureEventColor: 'Signature Event (Blue)',
  otherEventColor: 'Other Event (Gray)',
  linkColor: 'Link Color (Blue)',
};
